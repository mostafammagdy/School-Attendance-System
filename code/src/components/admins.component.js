                        ...
                        <main>
                            <div class="container-fluid">
                                ...
                                <div class="col-3">
                                    ...
                                    <form>
        <p className="h5 text-center mb-4">secretary details</p>
        <div className="grey-text">
            <input class="form-control" type="text" placeholder="first name" aria-label="Search" aria-describedby="basic-addon2" />
            <input class="form-control" type="text" placeholder="last name" aria-label="Search" aria-describedby="basic-addon2" />
            <p className="h5 text-center mb-4">login credentials</p>
          <input class="form-control" placeholder="example@something.com" icon="envelope" group type="email" validate error="wrong"
            success="right" />
          <input class="form-control" placeholder="password" icon="lock" group type="password" validate />
          <p className="h5 text-center mb-4">associated school</p>
          ...
          <option value="Lawrence Park Collegiate Institute">Lawrence Park Collegiate Institute</option>
          <option value="Parkdale Collegiate Institute">Parkdale Collegiate Institute</option>
          <option value="Thistletown Collegiate Institute">Thistletown Collegiate Institute</option>
          <option value="York Memorial Collegiate Institute">York Memorial Collegiate Institute</option>
          </select>
        </div>
        <button type="submit">Create Account</button>
      </form>
      <h2>Manage Secretary Account</h2>
      <p>
